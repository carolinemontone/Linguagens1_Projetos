...
public class Atividade2 {
    ...
    static Scanner sc1;
    static atividade2.Loja loja;
    static Carrinho carrinho;
    static ListaDeDesejos desejos;
    
    
    public static void main(String[] args) {
        sc1 = new Scanner(System.in);
        loja = new atividade2.Loja();
        carrinho = new Carrinho();
        desejos = new ListaDeDesejos();
    ...
    static public void finalizarPedido(){
        ...
        Pedido pedido = carrinho.criarPedido(cli);
    ...
    static public void menuInicial(){
        ...
        do {            
            ...
            op = sc1.nextInt();
            atividade2.Produto.departamento depTemp;
            ...
            switch (op){
                case 1:
                    ...
                    break;                    
                case 2:
                    depTemp = atividade2.Produto.departamento.games;
                case 3:
                    depTemp = atividade2.Produto.departamento.informatica;
                case 4:
                    depTemp = atividade2.Produto.departamento.livro;
                case 5:
                    depTemp = atividade2.Produto.departamento.moveis;
